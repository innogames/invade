...
$vagrant_network_ip = "192.168.124.4"
$vagrant_network_hostname = "local.invade"
...
$vagrant_puppet_modules_basic = [
  ['puppetforge','puppetlabs-apt', '1.4.2']
]
$vagrant_puppet_modules  = []

# VAGRANT - PLUGINS CONFIGURATION
$vagrant_plugins_auto_update = false
$vagrant_plugins_basic = ["vagrant-triggers", "vagrant-hostmanager", "vagrant-vbguest", "vagrant-cachier", "vagrant-librarian-puppet", "vagrant-bindfs"]
